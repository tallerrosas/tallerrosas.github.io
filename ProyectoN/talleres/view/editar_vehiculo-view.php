                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" name="update_register" id="update_register" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" required name="patente" class="form-control" id="patente" placeholder="Placa " value="<?php echo $patente ?>">
                                    </div>
                                    <label for="marca" class="col-sm-2 control-label">Cliente: </label>
                                    <div class="col-sm-4">
                                        <input type="text" required name="marca" class="form-control" id="marca" placeholder="Cliente: " value="<?php echo $marca ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="modelo" class="col-sm-2 control-label">Detalles: </label>
                                    <div class="col-sm-4">
                                        <input type="text" required name="modelo" class="form-control" id="modelo" placeholder="Detalles: " value="<?php echo $modelo ?>">
                                    </div>
                                    <label for="chasis" class="col-sm-2 control-label">Marca/Modelo: </label>
                                    <div class="col-sm-4">
                                        <input type="text" required name="chasis" class="form-control" id="chasis" placeholder="Marca/Modelo: " value="<?php echo $nro_chasis ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="motor" class="col-sm-2 control-label">Total a Pagar: </label>
                                    <div class="col-sm-4">
                                        <input type="text" required name="motor" class="form-control" id="motor" placeholder="Total a Pagar: " value="<?php echo $nro_motor ?>">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" name="estado" id="estado" required>
                                            <option value="1" <?php if ($estado==1){echo "selected";}?>>Reparado</option>
                                            <option value="2" <?php if ($estado==0){echo "selected";}?>>En Reparacion</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
