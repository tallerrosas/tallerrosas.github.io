        ...
        <section id="main-content">
            ...
            <div class="row">
                ...
                <div class="col-md-offset-10">
                    <!-- modals -->
                        <?php 
                            include "modals/agregar/agregar_reparacion.php";
                            include "modals/editar/editar_reparacion.php";
                        ?>
                    <!-- /end modals --> 
...
<script>
    ...
    function load(page){
        ...
        $("#loader").fadeIn('slow');
        $.ajax({
            url:'view/ajax/reparaciones_ajax.php',
            data: parametros,
...
<script>
    $( "#new_register" ).submit(function( event ) {
     ...
     var parametros = $(this).serialize();
         $.ajax({
                type: "POST",
                url: "view/ajax/agregar/agregar_reparacion.php",
                data: parametros,
                 beforeSend: function(objeto){
...
<script>
    $( "#update_register" ).submit(function( event ) {
     ...
     var parametros = $(this).serialize();
         $.ajax({
                type: "POST",
                url: "view/ajax/editar/editar_reparacion.php",
                data: parametros,
                 beforeSend: function(objeto){
                    $("#resultados_ajax").html("Enviando...");
                  },
...
<script>
    function editar(id){
        ...
        $.ajax({
                url:'view/modals/editar/reparacion.php',
                data: parametros,
                 beforeSend: function(objeto){
