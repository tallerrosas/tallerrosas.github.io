            ...
            <div class="row">
                <div class="col-xs-3">
                    <div class="input-group">
                      <input type="text" class="form-control" placeholder="Buscar por Placa" id='q' onkeyup="load(1);">
                ...
                <div class="col-md-offset-10">
                    ...
                    <a class="btn btn-primary" href="view/DownloadDOCS/Excel.php"></i>Descargar Excel</a>
                    <br>
